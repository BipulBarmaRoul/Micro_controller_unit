...
/**
  ******************************************************************************
  * @file           : LED_E-LED_BUZZER_BULB.c
  * Author          : BIPUL BARMA ROUL
  * @brief          : Using relay glow the 220v bulb, enable the BUZZER, and also toggle the internal and external LED using STM-32 cube IDE with HAL library
  ******************************************************************************
  * @attention
  *
...
int main(void)
{
  ...
  //lcd_cmd(0x01);
  lcd_cmd(0x80);
  lcd_display("WELCOME PHYTEC",14);
  lcd_cmd(0xc0);
  lcd_display("CHOOSE OPTION",13);
  HAL_Delay(2000);
  lcd_cmd(0x01);
  lcd_cmd(0x80);
  lcd_display("1:I-LED  2:E-LED",16);
  lcd_cmd(0xc0);
  lcd_display("3:BUZZER  4:BULB",16);
  while (1)
  {
	  ...
	  if(!(HAL_GPIO_ReadPin(GPIOC,GPIO_PIN_5)))
	  {
		  ...
		  HAL_Delay(300);
		  lcd_cmd(0x80);
		  lcd_display("EXT-LED GLOWING",14);
